...
-	Now create connection for Dbaas database and run Dbaas schema script. 
...
9.	Open Sql developer and connect to your ADWC environment and run ADWC schema script.

![](./images/demo12.png)

10.	Download ADWCS Demo shell script from GitHub and copy in oracle home directory.
...
17.	Download workspace file from git and import
...
23.	Download application script and give location in Choose file. 
